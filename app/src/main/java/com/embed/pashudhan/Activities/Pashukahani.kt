...
class Pashukahani : AppCompatActivity() {
...
// and returned in the Activity's onRequestPermissionsResult()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pashukahani)
    }
        ...
        if (resultCode != RESULT_CANCELED) {
            when (requestCode) {
                0 -> if (resultCode == RESULT_OK && data != null) {
                    ...
                    setContentView(R.layout.add_kahani)
    ...
    fun upload_data(){
        ...
        user_id = checkLoginSharedPref.getString(getString(R.string.sp_loginUserUUID), "0").toString()
